          ...
          {SITE_SECTIONS.map((section) => {
            ...
            return (
              ...
              >
                ...
                {section.required ? (
                  <div className="w-10 h-6 rounded-full bg-purple-600 opacity-50" />
                ) : (
        ...
        <form action="/api/admin/tenants/content" method="POST" className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-purple-400 resize-none"
            />
          </div>
