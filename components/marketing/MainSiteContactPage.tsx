...
function IconComments({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path
        d="M7 16l-3 3V7a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v9H7z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M17 10h1a2 2 0 0 1 2 2v7l-3-3h-5a2 2 0 0 1-2-2v-1"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function IconBook({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      <path
        d="M4 6a2 2 0 0 1 2-2h12v16H6a2 2 0 0 0-2 2V6z"
        stroke="currentColor"
        strokeWidth="2"
      />
      <path
        d="M18 20v-4H6a2 2 0 0 0-2 2"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
