...
export function bookingReminderEmail({
    ...
    /** IANA zone of the salon. See booking-confirmation for rationale. */
    ...
    // Reminders go out close to the appointment — explicit zone label removes
    // any ambiguity for clients travelling or in a different region.
