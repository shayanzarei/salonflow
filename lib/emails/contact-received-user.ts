...
<head>
  ...
  <title>We received your message — SoloHub</title>
</head>
<body style="margin:0;padding:0;background-color:#F8FCFF;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">

<div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">We got your message, ${safeName}. Our team will reply soon. &zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;</div>
            ...
            <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin-bottom:20px;">
              <tr>
                <td style="background:#ECFDF5;border:1px solid #A7F3D0;border-radius:999px;padding:5px 14px;">
                  <span style="font-size:12px;font-weight:700;color:#065F46;font-family:Inter,Arial,Helvetica,sans-serif;">&#10003;&nbsp; Message received</span>
                </td>
              </tr>
            </table>

            <h1 style="margin:0 0 8px;font-size:26px;font-weight:800;color:#0F172A;font-family:Inter,Arial,Helvetica,sans-serif;line-height:1.2;">We've got your message, ${safeName}</h1>
            <p style="margin:0 0 24px;font-size:15px;color:#475569;line-height:1.7;font-family:Inter,Arial,Helvetica,sans-serif;">Thanks for reaching out. Our team has received your inquiry and will get back to you as soon as possible — usually within a few hours during business days.</p>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
                    <tr>
                      <td style="border-bottom:1px solid #E2E8F0;padding-bottom:12px;">
                        <span style="font-size:13px;font-weight:700;color:#0F172A;font-family:Inter,Arial,Helvetica,sans-serif;">Your submission</span>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding-top:14px;padding-bottom:10px;">
                        <span style="display:block;font-size:11px;font-weight:600;color:#94A3B8;text-transform:uppercase;letter-spacing:0.07em;font-family:Inter,Arial,Helvetica,sans-serif;margin-bottom:3px;">Topic</span>
                        <span style="display:block;font-size:14px;font-weight:600;color:#0F172A;font-family:Inter,Arial,Helvetica,sans-serif;">${safeTopic}</span>
                      </td>
                    </tr>
                    <tr>
                      <td style="border-top:1px solid #E2E8F0;padding-top:12px;">
                        <span style="display:block;font-size:11px;font-weight:600;color:#94A3B8;text-transform:uppercase;letter-spacing:0.07em;font-family:Inter,Arial,Helvetica,sans-serif;margin-bottom:6px;">Your message</span>
                        <div style="background:#ffffff;border:1px solid #E2E8F0;border-left:3px solid #7C3AED;border-radius:0 8px 8px 0;padding:12px 14px;">
                          <span style="font-size:14px;color:#475569;line-height:1.6;font-family:Inter,Arial,Helvetica,sans-serif;font-style:italic;">${safeMessage}</span>
                        </div>
                      </td>
                    </tr>
                  </table>
