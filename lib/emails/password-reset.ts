  ...
  <tr>
    <td align="center" style="padding:40px 16px;">
      <table width="600" cellpadding="0" cellspacing="0" border="0" role="presentation" style="max-width:600px;width:100%;">
        ...
        <!-- Header — dark navy for security context -->
        <tr>
          <td style="background:#0F172A;border-radius:16px 16px 0 0;padding:36px 32px;text-align:center;" align="center">
            ...
            <p style="margin:0;font-size:11px;font-weight:700;letter-spacing:0.1em;color:rgba(255,255,255,0.5);text-transform:uppercase;font-family:Inter,Arial,Helvetica,sans-serif;">SOLOHUB</p>
          </td>
        </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin-bottom:24px;">
              <tr>
                <td style="background:#FFF7ED;border:1px solid #FED7AA;border-radius:10px;padding:14px 16px;">
                  <span style="font-size:13px;font-weight:700;color:#9A3412;font-family:Inter,Arial,Helvetica,sans-serif;">&#8987;&nbsp; This link expires in 60 minutes</span>
                </td>
              </tr>
            </table>
