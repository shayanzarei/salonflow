            ...
            <div style="display:flex;justify-content:center;gap:8px;">
              ${[1, 2, 3, 4, 5]
                ...
                <a href="${reviewUrl}&rating=${star}"
                  style="display:inline-block;width:48px;height:48px;border-radius:50%;background:#FAF7F4;border:1px solid #F0EBE4;text-align:center;line-height:48px;font-size:20px;text-decoration:none;color:#1a1a1a;">
                  ${star}★
                </a>
              `
                )
